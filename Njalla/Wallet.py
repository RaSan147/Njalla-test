...
class NjallaWallet:
        ...
        def __init__(self, api_key):
            ...
            # URL always stays the same. We post to it with different data.
        ...
        def add_payment(self, amount, via):
            ...
            if via not in ["paypal", "bitcoin", "litecoin", "monero", "zcash", "ethereum"]:
                raise ValueError("Invalid payment method. Possible values: paypal, bitcoin, litecoin, monero, zcash, ethereum")
            data = {
                "method": "add-payment",
                "params": {
                    "amount": amount,
